...
public class DBUtils {
    ...
    public static void saveSensor(Context context, double timestamp, int type, int data, String session_id) {
        ...
        step_count.put(Provider.Stepcount_Data.DEVICE_TIMESTAMP, timestamp);
        step_count.put(Provider.Stepcount_Data.STEP_COUNT, String.valueOf(data));
    ...
    public static void saveWatchIntervention(Context context, double timestamp, String session_id, int notif_type, int notif_device, int snooze_shown) {
        ...
        intervention.put(Provider.Notification_W_Interventions.TIMESTAMP, System.currentTimeMillis());
        intervention.put(Provider.Notification_W_Interventions.DEVICE_TIMESTAMP, String.valueOf(timestamp));
    ...
    public static void saveWatchResponse(Context context,   double timestamp, String session_id, int busy, int pain, int nausea,
        ...
        response.put(Provider.Notification_W_Responses.DEVICE_TIMESTAMP, String.valueOf(timestamp));
    ...
    public static void savePhoneIntervention(Context context, double timestamp, String session_id, int notif_type, int notif_device, int snooze_shown) {
        ContentValues intervention = new ContentValues();
        intervention.put(Provider.Notification_P_Interventions.DEVICE_ID, Aware.getSetting(context, Aware_Preferences.DEVICE_ID));
        intervention.put(Provider.Notification_P_Interventions.TIMESTAMP, System.currentTimeMillis());
        intervention.put(Provider.Notification_P_Interventions.DEVICE_TIMESTAMP, String.valueOf(timestamp));
    ...
    public static void savePhoneResponse(Context context,   double timestamp, String session_id, int busy, int pain, int nausea,
        ...
        response.put(Provider.Notification_P_Responses.TIMESTAMP, System.currentTimeMillis());
        response.put(Provider.Notification_P_Responses.DEVICE_TIMESTAMP, String.valueOf(timestamp));
        ...
        response.put(Provider.Notification_P_Responses.NOTIF_DEVICE, Constants.NOTIF_DEVICE_PHONE);
