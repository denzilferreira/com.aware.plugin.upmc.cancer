...
public class WebserviceHelper extends IntentService {
    ...
    private String getLatest(String protocol, String WEBSERVER, String DATABASE_TABLE, Hashtable<String, String> request) {
        ...
        Log.d(Aware.TAG, "LATEST REMOTE ENTRY RESULT: " + latest);
